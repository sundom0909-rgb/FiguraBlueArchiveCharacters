            ...
            exSkills = {
...

                {
                    ...
                    callbacks = {
                        onPreAnimation = function (self)
                            ...
                            for i = 1, 3 do
                                ...
                                self.exSkill.exSkills[2].shouldReplaceEmerald[i] = math.random() >= 0.9
                                if self.exSkill.exSkills[2].shouldReplaceEmerald[i] then
                        ...
                        onAnimationTick = function (self, tick)
                            ...
                            elseif tick == 37 then
                                self.exSkill.exSkills[2].spawnBulletParticle(self, models.models.ex_skill_2.Covers.CoverBack1.ExSkill2ParticleAnchor1, 0, 90, "MOMOI")
                                self.exSkill.exSkills[2].playShotSound(self)
                                if host:isHost() then
                                    models.models.ex_skill_2.Gui.UI.MomoiUI.Bullets.RearBullets.Bullet24:setColor()
                                end
                            elseif tick == 39 then
                                self.exSkill.exSkills[2].spawnBulletParticle(self, models.models.ex_skill_2.Covers.CoverBack1.ExSkill2ParticleAnchor9, 0, 90, "MOMOI")
                                self.exSkill.exSkills[2].playShotSound(self)
                            elseif tick == 41 then
                                self.exSkill.exSkills[2].spawnBulletParticle(self, models.models.ex_skill_2.Covers.CoverBack1.ExSkill2ParticleAnchor2, 0, 90, "MOMOI")
                                self.exSkill.exSkills[2].playShotSound(self)
                                if host:isHost() then
                            ...
                            elseif tick == 49 then
                                self.exSkill.exSkills[2].spawnBulletParticle(self, models.models.ex_skill_2.Pillagers.Pillager1.Pillager1Head.ExSkill2ParticleAnchor5, 0, 0, "MIDORI")
                                self.exSkill.exSkills[2].playShotSound(self) --ミドリの射撃音
                                if host:isHost() then
                            ...
                            elseif tick == 61 then
                                self.exSkill.exSkills[2].spawnBulletParticle(self, models.models.ex_skill_2.ExSkill2ParticleAnchor3, -90, 0, "MOMOI")
                                self.exSkill.exSkills[2].playShotSound(self)
                            elseif tick == 63 then
                                self.exSkill.exSkills[2].spawnBulletParticle(self, models.models.ex_skill_2.ExSkill2ParticleAnchor10, -90, 0, "MOMOI")
                                self.exSkill.exSkills[2].playShotSound(self)
                                if host:isHost() then
                                    models.models.ex_skill_2.Gui.UI.MomoiUI.Bullets.RearBullets.Bullet22:setColor()
                                end
                            elseif tick == 65 then
                                self.exSkill.exSkills[2].spawnBulletParticle(self, models.models.ex_skill_2.ExSkill2ParticleAnchor11, -90, 0, "MOMOI")
                                self.exSkill.exSkills[2].playShotSound(self)
                            elseif tick == 70 then
                                models.models.ex_skill_2.Momoi.MomoiHead.MomoiFaceParts.Eyes.EyeLeft:setUVPixels(12, 0)
                            ...
                            elseif tick == 73 and host:isHost() then
                                models.models.ex_skill_2.Gui.UI.MomoiHeadUI:setColor()
                            elseif tick == 74 then
                                self.exSkill.exSkills[2].spawnBulletParticle(self, models.models.ex_skill_2.Covers.CoverBack2.ExSkill2ParticleAnchor12, 0, -90, "MOMOI")
                                self.exSkill.exSkills[2].spawnBulletParticle(self, models.models.ex_skill_2.Covers.CoverBack3.ExSkill2ParticleAnchor6, 0, 0, "MIDORI")
                                self.exSkill.exSkills[2].playShotSound(self) --ミドリの射撃音
                                if host:isHost() then
                                    models.models.ex_skill_2.Gui.UI.MomoiUI.Bullets.RearBullets.Bullet21:setColor()
                                end
                            elseif tick == 76 then
                                self.exSkill.exSkills[2].spawnBulletParticle(self, models.models.ex_skill_2.Covers.CoverBack2.ExSkill2ParticleAnchor4, 0, 0, "MOMOI")
                                self.exSkill.exSkills[2].playShotSound(self)
                            elseif tick == 78 then
                                self.exSkill.exSkills[2].spawnBulletParticle(self, models.models.ex_skill_2.Covers.CoverBack2.ExSkill2ParticleAnchor13, 0, -90, "MOMOI")
                                self.exSkill.exSkills[2].playShotSound(self)
                                models.models.ex_skill_2.Momoi.MomoiHead.MomoiFaceParts.Eyes.EyeLeft:setUVPixels(36, 0)
                                models.models.ex_skill_2.Momoi.MomoiHead.MomoiFaceParts.Eyes.EyeRight:setUVPixels(30, 0)
                                models.models.ex_skill_2.Momoi.MomoiHead.MomoiFaceParts.Mouth:setUVPixels(32, 0)
                            ...
                            elseif tick == 93 then
                                self.exSkill.exSkills[2].spawnBulletParticle(self, models.models.ex_skill_2.Pillagers.Pillager2.Pillager2Body.ExSkill2ParticleAnchor7, 0, 0, "MIDORI")
                                self.exSkill.exSkills[2].playShotSound(self) --ミドリの射撃音
                                if host:isHost() then
                            ...
                            elseif tick == 111 then
                                self.exSkill.exSkills[2].spawnBulletParticle(self, models.models.ex_skill_2.Pillagers.Pillager3.Pillager3Body.ExSkill2ParticleAnchor8, 0, 0, "MIDORI")
                                self.exSkill.exSkills[2].playShotSound(self) --ミドリの射撃音
                            ...
                            elseif tick == 178 then
                                ...
                                self.parent.bubble:play("V", 24, false)
                                local playerPos = player:getPos()
                                sounds:playSound(self.parent.compatibilityUtils:checkSound("minecraft:entity.player.levelup"), playerPos, 1, 1.5)
                            ...
                            if tick >= 55 and tick < 82 then
                                self.exSkill.exSkills[2].spawnCoinParticles(self, 1)
                            end
                            if tick >= 98 and tick < 125 then
                                self.exSkill.exSkills[2].spawnCoinParticles(self, 2)
                            end
                            if tick >= 116 and tick < 143 then
                                self.exSkill.exSkills[2].spawnCoinParticles(self, 3)
                            end
                    ...
                    spawnCoinParticles = function (self, index)
                        ...
                        for _ = 1, 3 do
                            particles:newParticle(self.parent.compatibilityUtils:checkParticle("minecraft:end_rod"), vectors.vec3(math.random() - 0.5, math.random() - 0.5, math.random() - 0.5):add(anchorPos)):setVelocity(0, 0.1, 0):setColor(self.exSkill.exSkills[2].shouldReplaceEmerald[index] and vectors.vec3(0.686, 0.992, 0.804) or vectors.vec3(1, 0.984, 0.4)):setLifetime(8)
                        end
                    end;
                };
            };
