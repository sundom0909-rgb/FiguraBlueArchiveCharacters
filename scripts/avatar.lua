...
---@field public fireworkManager FireworkManager
...
Avatar = {
	...
	new = function ()
		...
		events.ENTITY_INIT:register(function ()
			...
			--生徒固有クラスの読み込み
			require("scripts.character_scripts.firework_manager")
			require("scripts.character_scripts.firework")
			instance.fireworkManager = FireworkManager.new(instance)
			instance.fireworkManager:init()
