...
ExSkill1TextObject = {
    ...
    new = function (parent, text)
        ...
        instance.text = text
        instance.currentPos = vectors.rotateAroundAxis(player:getBodyYaw() + 180, instance.parent.modelUtils.getModelWorldPos(models.models.main.Avatar.UpperBody.Arms.LeftArm.LeftArmBottom.GameConsole1.ExSkill1ParticleAnchor1):sub(player:getPos()), 0, 1, 0):scale(16)
