        ...
        self:transition("PRE", function ()
            ...
            if host:isHost() then
                events.RENDER:register(function ()
                    if not client:isPaused() then
                        self.parent.cameraManager.setCameraPivot(vectors.rotateAroundAxis(self.bodyYaw[2] * -1 + 180, models.models.main.CameraAnchor:getAnimPos():scale(1 / 16), 0, 1, 0):add(0, -1.62, 0))
