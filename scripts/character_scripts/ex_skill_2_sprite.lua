    ...
    new = function (parent, pos, velocity)
        ...
        instance.callbacks = {
            ...
            onInit = function (self)
                ...
                self.object:setPos(self.currentPos:copy():augmented(-2))
            ...
            onTick = function (self)
                ...
                if self.velocity:length() > 0 then
                    ...
                    self.object:setPos(self.currentPos:copy():add(25, 25):augmented(-2))
                end
            ...
            onRender = function (self, delta)
                self.object:setPos(self.currentPos:copy():add(self.nextPos:copy():sub(self.currentPos):scale(delta)):add(25, 25):augmented(-2))
            end;
        }
